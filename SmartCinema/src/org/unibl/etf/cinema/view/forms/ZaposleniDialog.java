...
public class ZaposleniDialog extends JDialog {
						...
						.addGroup(gl_contentPanel.createSequentialGroup()
							...
							.addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING, false)
								...
								.addGroup(gl_contentPanel.createSequentialGroup()
									...
									.addComponent(pfLozinka, GroupLayout.PREFERRED_SIZE, 225, GroupLayout.PREFERRED_SIZE))
								.addGroup(gl_contentPanel.createSequentialGroup()
	...
	private void sacuvajZaposlenog() {
		try {
			...
			Nalog nalog = new Nalog(tfKorisnickoIme.getText(), (Rola)cbRola.getSelectedItem());
