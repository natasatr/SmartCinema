...
public class DodatnaPonudaDialog extends JDialog {
			...
			gl_panel.setHorizontalGroup(
				gl_panel.createParallelGroup(Alignment.LEADING)
					.addGroup(gl_panel.createSequentialGroup()
						.addContainerGap()
						.addComponent(lblInformacijeODodatnoj, GroupLayout.PREFERRED_SIZE, 258, GroupLayout.PREFERRED_SIZE)
	...
	public void sacuvajDP() {
		...
		try
		{
			...
			JOptionPane.showMessageDialog(frame, "Dodatna ponuda dodana uspijesno.","Dodatna ponuda je dodana", JOptionPane.INFORMATION_MESSAGE);
		}catch(Exception ee)
		{
	...
	}else {try
	{
		...
		JOptionPane.showMessageDialog(frame, "Dodatna ponuda azurirana uspijesno.","Dodatna ponuda je dodana", JOptionPane.INFORMATION_MESSAGE);
	}catch(Exception ee)
	{
		JOptionPane.showMessageDialog(frame, "Greska pri cuvanju zaposlenog: " + ee.getMessage(), "Greska", JOptionPane.ERROR_MESSAGE);
	}
	...
	public void azurirajDP() {
		...
		try
		{
			...
			JOptionPane.showMessageDialog(frame, "Dodatna ponuda azurirana uspijesno.","Dodatna ponuda je azurirana", JOptionPane.INFORMATION_MESSAGE);
		}catch(Exception ee)
		{
			JOptionPane.showMessageDialog(frame, "Greska pri cuvanju zaposlenog: " + ee.getMessage(), "Greska", JOptionPane.ERROR_MESSAGE);
		}	
	...
	public void obrisiDP() {
		DodatnaPonudaDTO dp = ((DodatnaPonudaTableModel) table
				.getModel()).getDodatnaPonudaAtRow(table
				.getSelectedRow());
		try
		{
			dpDAO.obrisiDodatnuPonudu(dp.getNaziv());;
			setVisible(false);
			dispose();
			frame.refreshDP();
			
			JOptionPane.showMessageDialog(frame, "Dodatna ponuda obrisana uspijesno.","Dodatna ponuda je obrisana", JOptionPane.INFORMATION_MESSAGE);
		}catch(Exception ee)
		{
			JOptionPane.showMessageDialog(frame, "Greska pri cuvanju zaposlenog: " + ee.getMessage(), "Greska", JOptionPane.ERROR_MESSAGE);
		}	
